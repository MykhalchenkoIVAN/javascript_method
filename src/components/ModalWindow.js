  ...
  return (
    <>
      {props.state && (
        <div className="modal">
          <div
            className={`${props.stateTheme.modal__wrapper} modal__wrapper`}
            onClick={closeModal}
          ></div>
          <div className={`${props.stateTheme.modal__window} modal__window`}>
            <button
              className={`${props.stateTheme['modal__button-cancel']} modal__button-cancel`}
              onClick={closeModal}
            >
              &#215;
            </button>
            <div className="modal__header">
              <div className={`${props.stateTheme.modal__title} modal__title`}>
                <div
                  className={`${
                    ItemStyles[`type__${props.class}`]
                  } modal__type`}
                >
            ...
            <div
              className={`${props.stateTheme.modal__description} modal__description`}
            >
              {props.description
                ? props.description
                : 'Невдовзі буде доданий короткий опис'}
            </div>
            <div className="modal__code">
              <div
                className={`${props.stateTheme['modal__code-header']} modal__code-header`}
              >
                {stateBtn ? (
                  <div
                    className={`${props.stateTheme['modal__code-header-btn']} modal__code-header-btn`}
                  ...
                  <div className="modal__code-header-btn">
                    <CopyIconOk />
                  </div>
                )}
              </div>
