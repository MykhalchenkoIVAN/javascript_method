...
import './ButtonDarkLight.css'

const ButtonDarkLight = (props) => {
    const [isChecked, setIsChecked] = useState(true)
    useEffect(() => {
        const savedTheme = localStorage.getItem('theme');
        if (savedTheme) {
            setIsChecked(savedTheme == 'light' ? true : false)
        }
    }, [])
    ...
    //     if (isChecked) {
    //         console.log("sdsadsd");
    //         btn.classList.add('toggle__theme-btn-bg')
    //     }

    // }, [isChecked])
    // console.log(isChecked);
    return (
        <div className={`${props.stateTheme['toggle__theme-btn-bg']} toggle__theme-btn`} onClick={handleCheckboxChange}>
            {isChecked ?
                <svg fill="#f7df1e" width="1.5rem" height="1.5rem" viewBox="-7.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                ...
                :
                <svg
                    fill="rgba(13, 226, 13, 0.4) " width="1.5rem" height="1.5rem" viewBox="0 0 35 35" xmlns="http://www.w3.org/2000/svg">
